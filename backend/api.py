        ...
        "sources": [
            {
                "id": "remotive",
                "label": "Remotive",
                "description": "Calls Remotive's public remote-jobs API directly. No login or API key. Best for remote tech roles.",
            ...
            },
            {
                "id": "remoteok",
                "label": "RemoteOK",
                "description": "Reads RemoteOK's public JSON feed/remote-job URLs. No login or API key. Strong for remote tech/AI roles.",
                "production_safe": True,
                "needs_api_key": False,
            },
            {
                "id": "arbeitnow",
                "label": "Arbeitnow",
                "description": "Calls Arbeitnow's public job-board API. No login or API key. Mostly Europe + remote roles.",
                "production_safe": True,
                "needs_api_key": False,
            },
            {
                "id": "adzuna",
                "label": "Adzuna",
                "description": "Official Adzuna search API. Needs ADZUNA_APP_ID + ADZUNA_APP_KEY. Good for country-specific job search.",
                "production_safe": True,
                "needs_api_key": True,
            },
            {
                ...
                "description": "Calls RapidAPI JSearch. It aggregates jobs from providers such as LinkedIn, Indeed, Google Jobs, employer ATS pages, etc. This is not our own Indeed scraper.",
                "production_safe": True,
                "needs_api_key": True,
            },
            {
                "id": "manual",
                "label": "Manual import",
                "description": "No scraping. Reads jobs you pasted into data/manual_jobs.json. Useful for demos, testing, or a user-provided job list.",
                "production_safe": True,
                "needs_api_key": False,
            },
            {
                ...
                "description": "No scraping. Re-scores the last saved jobs from data/jobs.json.",
                "production_safe": True,
                "needs_api_key": False,
            },
            {
                ...
                "description": "Prototype scraper for public board URLs listed in config/job_boards.json. Only works after boards/selectors are configured.",
            ...
            },
            {
                ...
                "description": "Uses Playwright on your machine with a saved LinkedIn browser session. Experimental and not SaaS-safe.",
                "production_safe": False,
                "needs_api_key": False,
            },
        ]
